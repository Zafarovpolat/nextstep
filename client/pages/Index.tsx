    ...
    <div className="min-h-screen bg-white font-inter">
      ...
      <section className="relative w-full px-6 pt-[200px] pb-[100px]">
        ...
        <div className="relative z-10 max-w-[896px] mx-auto text-center">
          ...
          <div className="inline-flex items-center justify-center px-2 py-1 rounded-md border border-black/12 mb-10">
            <span className="text-[10px] font-medium text-black/60 tracking-[0.22px]">
              Currently in beta
            </span>
          </div>
          ...
          <p className="text-[15px] leading-6 text-black/50 max-w-[540px] mx-auto mb-12">
            Lightfield creates continuous, complete customer memory to keep
            records up to date, prepare for meetings, and automate follow-up
            work.
          </p>
      ...
      <section className="px-6 py-[120px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <p className="text-[14px] leading-6 tracking-[0.15px] text-black/50">
                Capture every single customer interaction automatically. From
                meetings and emails to customer support tickets and product
                analytics.
              </p>
              <p className="text-[14px] leading-6 tracking-[0.15px] text-black/50">
                Lightfield losslessly stores everything about your relationship
                with customer, ensuring that no follow up or valuable insight
        ...
        <div className="relative mt-[200px] h-[650px] overflow-hidden">
          <svg
            className="absolute left-[-30px] top-[50px] w-[1500px] h-[650px]"
            viewBox="0 0 1425 651"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <g opacity="0.2">
              <path
                d="M1385.38 72.3052L1301.63 325.66L1385.38 579.015L1469.13 325.66L1385.38 72.3052Z"
                fill="#F5F5F5"
                stroke="#666666"
                strokeWidth="0.65445"
              />
              <path
                d="M1301.57 324.85L1385.65 579.202"
                stroke="#666666"
                strokeWidth="0.65445"
              />
              <path
                d="M1315.53 282.625L1399.61 536.977"
                stroke="#666666"
                strokeWidth="0.65445"
              />
            </g>
            <g opacity="0.5">
              <path
                d="M1333.03 72.3052L1249.28 325.66L1333.03 579.015L1416.78 325.66L1333.03 72.3052Z"
                fill="#F5F5F5"
                stroke="#666666"
                strokeWidth="0.65445"
              />
            ...
            <path
              d="M1280.66 72.3086L1196.91 325.664L1280.66 579.019L1364.41 325.664L1280.66 72.3086Z"
              fill="#F5F5F5"
              stroke="#666666"
              strokeWidth="0.65445"
            />
            <path
              d="M729.093 325.457L1300.65 518.301"
              stroke="#666666"
              strokeWidth="0.4363"
            />
            <path
              d="M-29.1972 576.352L711.64 325.043"
              stroke="#666666"
              strokeWidth="0.4363"
            />
            <ellipse
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <p className="text-[14px] leading-6 tracking-[0.15px] text-black/50">
                ...
                powered CRM. Lightfield's advanced algorithms analyze patterns
                and automate workflows, helping you focus on what matters most -
      ...
      <section className="px-6 py-[120px]">
        <div className="max-w-[970px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-[72px]">
            ...
            <div className="space-y-6">
              <p className="text-[14px] leading-6 tracking-[0.15px] text-black/50">
                Ask questions in natural language to uncover insights across
                your customer data.
              </p>
              <p className="text-[14px] leading-6 tracking-[0.15px] text-black/50">
                Lightfield digs through structured CRM objects and heaps of
                unstructured customer conversations, allowing you to precisely
                hone your product roadmap and go to market motion with simple
